...
% to update a specific category data
...
% to update seat count
update_available_count(<<"available_seat_count">>,
                       Film_record,SeatsData,Category_to_update, New_data)->
  ...
  TotalSeats = 
  lists:sum([maps:get(<<"available_seat_count">>, Map) || Map <- Updated_data]),
...
% to update the available seat count when added
